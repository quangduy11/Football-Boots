<%-- 
    Document   : main_nav Sticky
    Created on : Mar 4, 2024, 4:37:05 PM
    Author     : Admin
--%>
										...
										<ul>
											<li>
												<a href="product-detail-1.html">
													<figure><img src="${pageContext.request.contextPath}/img/products/product_placeholder_square_small.jpg" data-src="img/products/shoes/thumb/1.jpg" alt="" width="50" height="50" class="lazy"></figure>
											...
											<li>
												<a href="product-detail-1.html">
													<figure><img src="${pageContext.request.contextPath}/img/products/product_placeholder_square_small.jpg" data-src="img/products/shoes/thumb/2.jpg" alt="" width="50" height="50" class="lazy"></figure>
